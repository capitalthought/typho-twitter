...
The source code is hosted on GitHub: http://github.com/shock/typho-twitter
...
* RDoc: http://rdoc.info/projects/shock/typho-twitter/

== How to submit patches

The source code is hosted on the GitHub: http://github.com/shock/typho-twitter
